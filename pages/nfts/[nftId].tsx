...
const Nft = () => {
  ...
  const nftModule = useMemo(() => {
    ...
    const sdk = new ThirdwebSDK(provider.getSigner(), {
      readOnlyRpcUrl: `https://rinkeby.infura.io/v3/${process.env.INFURA_PROJECT_ID}`
    })

    return sdk.getNFTModule('66a576A977b7Bccf510630E0aA5e450EC11361Fa')
  }, [provider])
  ...
  const marketPlaceModule = useMemo(() => {
    ...
    return sdk.getMarketplaceModule('0x8b5DDe34a96fb8471e0e8894051982939836e09e')
  }, [provider])
